    ...
    <>
      ...
      <div className="flex md:flex-row flex-col w-full pt-[47px] justify-between md:gap-10 md:mb-7 md:px-7 md:pt-[98px]">
        <div className="flex px-3 md:-px-0 w-full flex-col gap-2.5">
          <div className="flex gap-0 justify-between lg:justify-normal md:gap-2">
          ...
          <p className="text-subtext2 text-mobile_body3_m lg:hidden">
        ...
        <div className="lg:flex flex-row w-full lg:justify-between lg:max-w-[642px] hidden">
          {CATEGORY.map((item) => {
            return (
              <div
